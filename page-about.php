                ...
                <div class="p-about-profile__inner l-inner">
                    ...
                    <div class="p-about-profile__body u-fade-up u-delay-400">
                        ...
                        <div class="p-about-profile__text">
                            <p>
                                静岡県浜松市出身。社会人経験を経て、「自身のスキルで価値を提供したい」という想いから、WEB制作者への転身を決意しました。
                            </p>
                            <p>
                                 現在はWEB制作スクール「デイトラ」にて、HTML/CSSを基礎から学び、Sass（FLOCSS）による保守性を意識したコード設計や、WordPressのオリジナルテーマ開発に取り組んでいます。特に、デザインカンプの意図を汲み取ったピクセルパーフェクトな実装と、運用者が迷わず更新できる管理画面設計を重視し、実務を想定した制作を行っています。
                            </p>
                            <p>
                        ...
                        <ul class="p-about-strength__list">
                            ...
                            <li class="p-about-strength__item u-fade-up">
                                ...
                                <p class="p-about-strength__text">
                                    未経験からWEB制作の世界に飛び込みましたが、「わからない」をそのままにせず、納得がいくまでとことん調べるのが私のスタイルです。エラーや新しい技術に直面した際も、単なるコピペで終わらせず「なぜそう動くのか」という根本理解を大切にしています。この姿勢を活かし、意図のある確実な実装を行います。
                                </p>
                            </li>
                            ...
                            <li class="p-about-strength__item u-fade-up u-delay-200">
                                ...
                                <p class="p-about-strength__text">
                                    一度決めた目標は最後までやり抜きます。プライベートでは、筋力トレーニングを10年間続けています。トレーニングで培った「コツコツ続ける体力と根気」は、WEB制作における地道な修正作業や、長時間のコーディング集中力にも活きています。困難な実装も投げ出さず、しっかりと形にします。
                                </p>
                            </li>
